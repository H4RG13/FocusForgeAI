  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <h3 className="mb-1 text-base font-semibold text-gray-900">Generate Study Plan</h3>
      ...
      {(polling || plan) && (
        <div className="rounded-2xl border border-indigo-100 bg-indigo-50 p-6">
          {polling ? (
            ...
            <div>
              <h4 className="mb-3 text-sm font-semibold text-indigo-900">Your Study Plan</h4>
