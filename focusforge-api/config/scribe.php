...
return [
    ...
    'description' => 'REST API for FocusForge AI — an AI-powered productivity and study companion. All endpoints (except auth) require a Bearer token obtained from /api/v1/auth/login.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token by calling <code>POST /api/v1/auth/login</code> with your email and password. Pass it as <code>Authorization: Bearer {token}</code> on all protected requests.',
    ],
